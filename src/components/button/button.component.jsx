const BUTTON_TYPE_CLASSES = {
  ...
  buttonOneAlt:
    "flex flex-[0_0_100%] items-center text-white justify-center bg-[#D87D4A] w-full max-w-[160px] min-h-[48px] uppercase text-[13px] tracking-[1px] xl:mx-0 hover:bg-[#FBAF85]",
  buttonTwo:
